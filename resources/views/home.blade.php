        ...
        <div class="hero-content">
            ...
            <div class="search-box" id="heroSearchBox">
                ...
                <input type="text" id="searchInput" placeholder="Cari destinasi, tempat makan, atau budaya..."
                    autocomplete="off" />
                <span class="material-symbols-outlined clear-icon" id="searchClear">close</span>
                <button type="button" id="searchButton">Cari</button>
                <div id="searchSuggestions" class="search-suggestions"></div>
            </div>
            <!-- Feedback hasil pencarian (hidden by default) -->
            <div id="searchFeedback" class="search-feedback"></div>

            <div class="hero-cta-group">
                <!-- CUKUP UBAH KODE DI BAWAH INI (data-video-id) UNTUK MENGGANTI VIDEO -->
                <!-- Masukkan ID video YouTube (kode acak setelah v= di URL YouTube) -->

                <!-- Tombol 1: Jelajahi Kota -->
                <a href="#" class="cta-btn" id="btn-jelajahi-kota" data-video-id="iKUdILVt41o">Jelajahi Kota</a>

                <!-- Tombol 2: Cek Layanan -->
    ...
    <main class="page-content">
        ...
        ">
          ...
          ">sentiment_dissatisfied</span>
            ...
            font-size: 1.8rem;
          ">
                Maaf, tidak ada konten yang cocok.
            </h3>
            <p style="color: var(--gray); font-size: 1.1rem; margin-top: 10px">
                Coba gunakan kata kunci lain (misalnya: 'kuliner', 'universitas',
                'sejarah') atau hapus pencarian Anda.
            </p>
        </div>
        ...
        <section class="section-story" id="story-section">
            ...
            background-image: linear-gradient(
              ...
              url('https://kediripedia.com/wp-content/uploads/2024/03/COLLECTIE_TROPENMUSEUM_Verhoogde_Brantasbrug_te_Kediri_Oost-Java_TMnr_10007564-1.jpg');
          ">
                <div class="story-content animate-on-scroll animate-slide-in-left">
                    <h2>Kediri Bercerita</h2>
                    <h3>Sejarah Kota Kediri</h3>
                    <p>
                        Kerajaan Kediri, juga disebut Panjalu, berpusat di Daha dan
                        kisahnya tertuang dalam kitab Negarakertagama. Pada tahun 1041,
                        Raja Airlangga membagi kerajaannya menjadi dua untuk menghindari
        ...
        <section class="section-nearby-places" id="nearby-section">
            <div class="nearby-places-container">
                <div class="nearby-places-header animate-on-scroll animate-slide-up">
                    ...
                    <p>
                        Temukan berbagai lokasi penting di Kota Kediri seperti tempat
                        wisata, kuliner, sekolah, universitas, fasilitas kota, rental
                        kendaraan, hingga pondok pesantren. Pilih kategori yang kamu
                        butuhkan dan jelajahi dengan cepat dan mudah.
                    </p>
                </div>
                <div class="nearby-places-filters animate-on-scroll animate-slide-up">
                    <button class="filter-btn active" data-filter="wisata">
                        Wisata & Kuliner
                    </button>
                    ...
                    <button class="filter-btn" data-filter="transportasi">
                        Transportasi & Rental
                    </button>
                </div>
                <!-- ==== Peta Interaktif ==== -->
            ...
            <div class="popular-tours-container">
                ...
                <div class="popular-tours-slider-wrapper animate-on-scroll animate-stagger">
                    ...
                    <div class="popular-tours-grid">
                        <div class="tour-card">
                            <img src="{{ asset('image/sumber_banteng.webp') }}"
                                alt="Sumber Banteng" />
                        ...
                        <div class="tour-card">
                            <img src="{{ asset('image/taman_sekartaji.webp') }}"
                                alt="Taman Sekartaji" />
                            <div class="tour-card-title">
                                <h3>Taman Sekartaji, Mojoroto</h3>
                            </div>
                        </div>
                        <div class="tour-card">
                        ...
                        <div class="culinary-slider">
                            <div class="culinary-card">
                                ...
                                <div class="culinary-card-info">
                                    ...
                                    <p class="price">
                                        start from <strong>25k idr</strong> per orang
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="culinary-card">
                                <img src="{{ asset('image/pecel_pudakit.webp') }}"
                                    alt="Kuliner 3" />
                                <div class="culinary-card-info">
                                    <div class="card-info-row">
                                        <h4>Pecel Pudakit</h4>
                                    ...
                                    <p class="price">
                                        start from <strong>10k idr</strong> per box
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="culinary-card">
                                ...
                                <div class="culinary-card-info">
                                    ...
                                    <p class="price">
                                        start from <strong>22k idr</strong> per orang
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="culinary-card">
                                ...
                                <div class="culinary-card-info">
                                    ...
                                    <p class="price">
                                        start from <strong>10k idr</strong> per orang
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="section-education" id="education-section">
            <div class="education-container">
                <div class="education-header animate-on-scroll animate-slide-up">
                    ...
                    <p>
                        Di Kediri, belajar bisa di mana saja — ada kampus keren, sekolah
                        favorit, sampai pondok pesantren terkenal. Kota ini jadi tempat
                        tumbuhnya pelajar dan mahasiswa yang ingin berkembang, baik dalam
                        ilmu, kreativitas, maupun karakter.
                    </p>
                </div>
                <div class="education-filters animate-on-scroll animate-slide-up">
                    <button class="filter-btn active" data-filter="univ">
                        Universitas
                    </button>
                    <button class="filter-btn" data-filter="sd">Sekolah Dasar</button>
                    <button class="filter-btn" data-filter="pesantren">
                        Pondok Pesantren
                    </button>
                    ...
                    <div class="education-grid">
                        ...
                        <div class="education-card" data-category="univ">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Universitas Dian Nuswantoro adalah salah satu perguruan
                                    tinggi swasta terakreditasi Perguruan Tinggi Unggul yang
                                    hadir di Kota Kediri.
                                </p>
                            </div>
                        </div>
                        <div class="education-card" data-category="univ">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Institut Ilmu Kesehatan pertama di Indonesia yang mencetak
                        ...
                        <div class="education-card" data-category="univ">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Universitas Islam Kadiri adalah universitas swasta tertua di
                                    Kediri yang terus berinovasi.
                                </p>
                            </div>
                        </div>
                        <div class="education-card" data-category="univ">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Kampus pencetak pendidik dan wirausahawan muda yang kompeten
                                    di bidangnya.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="education-card hidden-card" data-category="sd">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Sekolah dasar swasta yang mengedepankan pendidikan karakter
                                    dan disiplin tinggi.
                                </p>
                            </div>
                        </div>
                        <div class="education-card hidden-card" data-category="sd">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Sekolah dasar berbasis Islam terpadu yang memadukan
                                    kurikulum nasional dan keagamaan.
                                </p>
                            </div>
                        </div>
                        <div class="education-card hidden-card" data-category="sd">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Salah satu sekolah dasar favorit dengan segudang prestasi
                                    akademik dan non-akademik di Kota Kediri.
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="education-card hidden-card" data-category="pesantren">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Salah satu pesantren terbesar dan tertua di Indonesia,
                                    menjadi pusat studi Islam klasik.
                                </p>
                            </div>
                        </div>
                        <div class="education-card hidden-card" data-category="pesantren">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Pondok pesantren besar yang terletak di pusat kota, fokus
                                    pada pendalaman Al-Quran dan Hadits.
                                </p>
                            </div>
                        </div>
                        <div class="education-card hidden-card" data-category="pesantren">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Pesantren yang dikenal dengan kegiatan Mujahadah Kubro dan
                        ...
                        <div class="education-card hidden-card" data-category="lainnya">
                            ...
                            <div class="education-card-info">
                                ...
                                <h3>SMAN 1 Kediri</h3>
                                <p class="description">
                                    Sekolah menengah atas rujukan dengan fasilitas lengkap dan
                                    lulusan berkualitas.
                                </p>
                            </div>
                        </div>
                        <div class="education-card hidden-card" data-category="lainnya">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Madrasah unggulan dengan berbagai program keterampilan dan
                                    prestasi nasional.
                                </p>
                            </div>
                        </div>
                        <div class="education-card hidden-card" data-category="lainnya">
                            ...
                            <div class="education-card-info">
                                ...
                                <p class="description">
                                    Pusat literasi warga dengan koleksi buku lengkap dan ruang
                                    baca yang nyaman.
                                </p>
                            </div>
                        </div>
        ...
        <section class="section-agenda" id="agenda-section">
            ...
            background-image: linear-gradient(
              ...
              url('https://live.staticflickr.com/65535/54928693191_2360361fea.jpg');
          ">
                <div class="agenda-content animate-on-scroll animate-slide-in-left">
                    ...
                    <p>Nantikan Setiap Keseruan yang akan datang di Kota Kediri</p>
                    <!-- Card Preview Kiri -->
                ...
                <div class="gallery-content">
                    <div class="gallery-blog-card animate-on-scroll animate-slide-in-left">
                        ...
                        <div class="gallery-blog-info">
                            ...
                            <p>
                                Temukan pesona Kota Kediri yang menawan, surga tersembunyi
                                di lereng Gunung Wilis yang menawarkan kesegaran dan
                                pemandangan...
                            </p>
                    ...
                    <div class="gallery-full-card animate-on-scroll animate-slide-up"
                        style="
                background-image: url('{{ asset('image/gunungklotok.png') }}');
              ">
                        <div class="gallery-full-content">
                            <h3>Video Terbaru: Pesona Malam Hari Kota Kediri</h3>
                            <p>
                                Lihat bagaimana ikon Kota Kediri ini bersinar di malam hari.
                            </p>
